...
//                   let directionText = "-";
//                   if (tx.type === "transfer") {
//                     if (tx.fromUser === userEmail) {
//                       directionText = `to ${tx.toUser}`;
//                     } else if (tx.toUser === userEmail) {
//                       directionText = `from ${tx.fromUser}`;
//                     }
//                   }
...
//                       <td>
//                         {tx.convertedAmount
//                           ? `${Number(tx.convertedAmount).toFixed(2)} ${tx.targetCurrency || ""}`
//                           : "-"}
//                       </td>
//                      <tbody>
//   {transactions.map((tx) => {
...
//     let directionText = "-";
//     if (tx.type === "transfer") {
//       directionText = `to ${tx.to}`;
//     } else if (tx.type === "received") {
//       directionText = `from ${tx.from}`;
//     }
              ...
              <tbody>
                {transactions.map((tx) => {
                  ...
                  const handleDelete = async () => {
                    ...
                    try {
                      await api.delete(`/wallet/history/${tx._id}`);
